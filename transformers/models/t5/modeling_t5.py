...
class T5LayerNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        hidden_states = hidden_states.view(-1, 1, self.weight.shape[-1])
       #  print(hidden_states.shape)
        ...
        return (self.weight * hidden_states).view(1,-1,self.weight.shape[-1])
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        # assert convert_layer_id <= self.num_layers
        # Model parallel
        ...
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            if convert_layer_id is not None:
                # if (convert_layer_id == 24): 
                #     break
                if (i != convert_layer_id) :
                    continue
            ...
            # divide block layer to convert to onnx
            if convert_layer_id is not None:
