...
data_root = '/data/jichuang/dataset/comic-5k-2'
...
fp32_attention = True
load_from = "/data/jichuang/pretrained_models/PixArt-Sigma-XL-2-512-MS.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
resume_from = None
vae_pretrained = "/data/jichuang/pretrained_models/pixart_sigma_sdxlvae_T5_diffusers/vae"  # sdxl vae
...
validation_prompts = [
    "dog",
    "cat",
    "A young girl with a red sweater, cuddling with a rabbit in a cozy corner.",
]